      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="relative">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-zinc-800 bg-zinc-900 px-4 py-3 text-sm transition hover:bg-zinc-800 disabled:opacity-50"
          >
            <GitHubIcon className="h-4 w-4" />
            {loading === "github" ? "Redirecting..." : "GitHub"}
          </button>
          {lastMethod === "github" && (
            <span className="absolute -top-2 right-2 rounded-full bg-green-500/10 px-1.5 py-0.5 text-[9px] font-medium text-green-400">
              Last used
            </span>
          )}
        </div>
